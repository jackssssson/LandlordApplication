...
public class Constants {
    ...
    public static final String postLandlord = "http://192.168.43.151:8080/user/addLandlord";
    public static final String postTenant = "http://192.168.43.151:8080/user/addTenant";
    ...
    public static final String isLoginCorrect = "http://192.168.43.151:8080/user/checkLogin";

    public static final String getByUserNameAndPassword = "http://192.168.43.151:8080/user/getUser";
}
